...
gameSettings.toggleSound = function togSound(){
...
let smoothie = {
  flavor: "A Minecraft Movie's Steve played by Jack Black blast",
  size: 30,
  hasProtein: false,
}
  ...
  function problem3() {
    ...
    newSize = prompt(`What size do your ${smoothie.flavor}?`)
...
let gadget = {
  Name: "Expolde Any Countryator",
  batteryLife: 27,
  Wireless: true,
}

function printGadgetSpecs(gadget) {
  return `Name: ${gadget.Name}, Battery Life: ${gadget.batteryLife} hrs, Wireless: ${gadget.Wireless}`
}
...
let garden = {
  plants: [],
  addPlant: function addPlant(plant){
...
let playlist = {
  name: "Best songs in the known universe",
  songList: [],
  addSong: function newSong(song){
